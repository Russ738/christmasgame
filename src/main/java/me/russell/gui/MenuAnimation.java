        ...
        for (int i = 0;i>20;i++) {
            ...
            timeline.getKeyFrames().addAll(
                    new KeyFrame(Duration.ZERO, // set start position at 0
                            new KeyValue(snowFlakes.translateYProperty(), random() * 100),
                            new KeyValue(snowFlakes.translateXProperty(), random() * 50)),
                    new KeyFrame(new Duration(40000), // set end position at 40s
                            new KeyValue(snowFlakes.translateYProperty(), random() * 800),
                            new KeyValue(snowFlakes.translateXProperty(), random() * 400)));
        }
